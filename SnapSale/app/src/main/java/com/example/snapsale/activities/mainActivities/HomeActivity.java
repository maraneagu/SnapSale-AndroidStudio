...
public class HomeActivity extends AppCompatActivity implements CustomBottomNavigationView.OnNavigationItemSelectedListener,
    ...
    private TextView kauflandSalesText, lidlSalesText, carrefourSalesText, pennySalesText,
            kauflandFavoredSalesText, lidlFavoredSalesText, carrefourFavoredSalesText, pennyFavoredSalesText,
            kauflandBasketsText, lidlBasketsText, carrefourBasketsText, pennyBasketsText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kauflandFavoredSalesText = findViewById(R.id.home_kaufland_favored_sales_count);
        kauflandBasketsText = findViewById(R.id.home_kaufland_baskets_count);

        lidlSalesText = findViewById(R.id.home_lidl_sales_count);
        lidlFavoredSalesText = findViewById(R.id.home_lidl_favored_sales_count);
        lidlBasketsText = findViewById(R.id.home_lidl_baskets_count);

        carrefourSalesText = findViewById(R.id.home_carrefour_sales_count);
        carrefourFavoredSalesText = findViewById(R.id.home_carrefour_favored_sales_count);
        carrefourBasketsText = findViewById(R.id.home_carrefour_baskets_count);

        pennySalesText = findViewById(R.id.home_penny_sales_count);
        pennyFavoredSalesText = findViewById(R.id.home_penny_favored_sales_count);
        pennyBasketsText = findViewById(R.id.home_penny_baskets_count);

        setStoreButtons();
        setFavoredStoreButtons();
        setBasketsButtons();
        setTranslateButton();
    }
    ...
    private void getSales() {
        salesRepository.getSales((List<Sale> sales) -> {
            SaleAdapter adapter = new SaleAdapter(HomeActivity.this, sales);
    ...
    private void getSalesCount() {
        ...
        salesRepository.getSalesCount(storeKeywords[1], (salesCount) -> lidlSalesText.setText(String.valueOf(salesCount)));
        salesRepository.getSalesCount(storeKeywords[3], (salesCount) -> carrefourSalesText.setText(String.valueOf(salesCount)));
    ...
    private void setStoreButtons() {
        ...
        kauflandButton.setOnClickListener(view -> ActivityNavigator.navigate(HomeActivity.this, KauflandActivity.class));

        RelativeLayout lidlButton = findViewById(R.id.home_lidl_btn);
        lidlButton.setOnClickListener(view -> ActivityNavigator.navigate(HomeActivity.this, LidlActivity.class));

        RelativeLayout carrefourButton = findViewById(R.id.home_carrefour_btn);
        carrefourButton.setOnClickListener(view -> ActivityNavigator.navigate(HomeActivity.this, CarrefourActivity.class));

        RelativeLayout pennyButton = findViewById(R.id.home_penny_btn);
        pennyButton.setOnClickListener(view -> ActivityNavigator.navigate(HomeActivity.this, PennyActivity.class));
    }

    private void getFavoredSalesCount() {
        favoredSalesRepository.getFavoredSalesCount(storeKeywords[0], (salesCount) -> kauflandFavoredSalesText.setText(String.valueOf(salesCount)));
        favoredSalesRepository.getFavoredSalesCount(storeKeywords[1], (salesCount) -> lidlFavoredSalesText.setText(String.valueOf(salesCount)));
        favoredSalesRepository.getFavoredSalesCount(storeKeywords[3], (salesCount) -> carrefourFavoredSalesText.setText(String.valueOf(salesCount)));
        favoredSalesRepository.getFavoredSalesCount(storeKeywords[2], (salesCount) -> pennyFavoredSalesText.setText(String.valueOf(salesCount)));
    }

    private void setFavoredStoreButtons() {
        RelativeLayout kauflandFavoredButton = findViewById(R.id.home_kaufland_favored_btn);
        kauflandFavoredButton.setOnClickListener(view -> ActivityNavigator.navigateToStore(HomeActivity.this, FavoritesActivity.class, storeKeywords[0]));

        RelativeLayout lidlFavoredButton = findViewById(R.id.home_lidl_favored_btn);
        lidlFavoredButton.setOnClickListener(view -> ActivityNavigator.navigateToStore(HomeActivity.this, FavoritesActivity.class, storeKeywords[1]));

        RelativeLayout carrefourFavoredButton = findViewById(R.id.home_carrefour_favored_btn);
        carrefourFavoredButton.setOnClickListener(view -> ActivityNavigator.navigateToStore(HomeActivity.this, FavoritesActivity.class, storeKeywords[3]));

        RelativeLayout pennyFavoredButton = findViewById(R.id.home_penny_favored_btn);
        pennyFavoredButton.setOnClickListener(view -> ActivityNavigator.navigateToStore(HomeActivity.this, FavoritesActivity.class, storeKeywords[2]));
    }

    private void getBasketsCount() {
        basketsRepository.getBasketsCount(storeKeywords[0], (salesCount) -> kauflandBasketsText.setText(String.valueOf(salesCount)));
        basketsRepository.getBasketsCount(storeKeywords[1], (salesCount) -> lidlBasketsText.setText(String.valueOf(salesCount)));
        basketsRepository.getBasketsCount(storeKeywords[3], (salesCount) -> carrefourBasketsText.setText(String.valueOf(salesCount)));
    ...
    private void setBasketsButtons() {
        ...
        kauflandBasketsButton.setOnClickListener(view -> ActivityNavigator.navigateToStore(HomeActivity.this, BasketsActivity.class, storeKeywords[0]));

        LinearLayout lidlBasketsButton = findViewById(R.id.home_lidl_baskets_btn);
        lidlBasketsButton.setOnClickListener(view -> ActivityNavigator.navigateToStore(HomeActivity.this, BasketsActivity.class, storeKeywords[1]));

        LinearLayout carrefourBasketsButton = findViewById(R.id.home_carrefour_baskets_btn);
        carrefourBasketsButton.setOnClickListener(view -> ActivityNavigator.navigateToStore(HomeActivity.this, BasketsActivity.class, storeKeywords[3]));

        LinearLayout pennyBasketsButton = findViewById(R.id.home_penny_baskets_btn);
        pennyBasketsButton.setOnClickListener(view -> ActivityNavigator.navigateToStore(HomeActivity.this, BasketsActivity.class, storeKeywords[2]));
    }
    ...
    private void setTranslateButton() {
        ...
        TextView favoredExploreText = findViewById(R.id.home_favored_explore_text);
        ...
        translateButton.setOnClickListener(view -> {
            if (sourceLanguage.equals("ro")) {
                ...
                favoredExploreText.setText(R.string.explore_favored_romanian);
                ...
                favoredExploreText.setText(R.string.explore_favored);
                basketsExploreText.setText(R.string.explore_baskets);
            }
        });
    }

    private class SaleAdapter extends ArrayAdapter<Sale> {
        List<Sale> sales;
            ...
            autoCompleteTextView.setOnItemClickListener((parent, view, position, id) -> {
                ...
                if (selectedSale != null) {
                    ...
                    if (selectedSale.getStore().equals(storeKeywords[0])) {
                        ActivityNavigator.navigateToCategory(HomeActivity.this, KauflandActivity.class, selectedSale.getCategory());
                    }
                    else if (selectedSale.getStore().equals(storeKeywords[1])) {
                        ActivityNavigator.navigateToCategory(HomeActivity.this, LidlActivity.class, selectedSale.getCategory());
                    }
                    else if (selectedSale.getStore().equals(storeKeywords[2])) {
                        ActivityNavigator.navigateToCategory(HomeActivity.this, PennyActivity.class, selectedSale.getCategory());
                    }
                    if (selectedSale.getStore().equals(storeKeywords[3])) {
                        ActivityNavigator.navigateToCategory(HomeActivity.this, CarrefourActivity.class, selectedSale.getCategory());
                    }
                }
            });
        }
        ...
        private void setLogos(View view, Sale sale) {
            ...
            else if (sale.getStore().equals(storeKeywords[1])) {
                setLogo(view, R.drawable.lidl_text_blue, R.dimen.lidlHomeDimen);
            }
            else if (sale.getStore().equals(storeKeywords[2])) {
                setLogo(view, R.drawable.penny_logo_blue, R.dimen.pennyHomeDimen);
            }
            else if (sale.getStore().equals(storeKeywords[3])) {
                setLogo(view, R.drawable.carrefour_logo_blue, R.dimen.carrefourHomeDimen);
            }
        }
        ...
        private void setImageLayout(View view, Sale sale) {
            ...
            if (sale.getStore().equals(storeKeywords[1]) && sale.getCategory().equals("market")) {
                imageLayout.setBackground(getResources().getDrawable(R.drawable.home_autocomplete_lidl_market_image_bkg));
            }
            else {
        ...
        private void setImage(View view, Sale sale) {
            ...
            if (!sale.getStore().equals(storeKeywords[2])) {
                Glide.with(HomeActivity.this).load(sale.getImage()).into(image);
            }
            else {
                Glide.with(HomeActivity.this).load(getResources().getDrawable(R.drawable.penny_logo)).into(image);
            }
        }
