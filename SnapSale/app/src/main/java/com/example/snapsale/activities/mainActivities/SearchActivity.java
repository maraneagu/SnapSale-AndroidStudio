...
public class SearchActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onResume() {
        ...
        Checker.checkMove(SearchActivity.this);
    }
    ...
    private void setStoreLayouts() {
        ...
        lidlLayout.setOnTouchListener(new SwipeListener(lidlLayout, 1, LidlActivity.class));

        RelativeLayout megaImageLayout = findViewById(R.id.search_carrefour);
        megaImageLayout.setOnTouchListener(new SwipeListener(megaImageLayout, -1, CarrefourActivity.class));
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (movedOverThreshold && Math.abs(deltaSwipe) > SWIPE_THRESHOLD) {
                        if (swipeDirection * deltaSwipe > 0) {
                            ActivityNavigator.navigate(SearchActivity.this, storeClass);
                        }
                    }
